...
local states =
{
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/idle")
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(13*FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/meat_hork")
            end),
...
--            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/land_explode")
        end,
