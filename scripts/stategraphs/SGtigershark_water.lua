...
ground == GROUND.WATER_MANGROVE or
...
local states =
{
    ...
    State{
        ...
        timeline =
        {
            ...
            TimeEvent(0*FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_emerge_lrg")
            end),

            TimeEvent(14*FRAMES, function(inst)
                inst:PerformBufferedAction()
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/eat")
            end),

            TimeEvent(31*FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_submerge_lrg")
            end),
        },
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(10*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_submerge_lrg") end),
...
--            end
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/jump_attack")
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_emerge_lrg")
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/roar")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/jump_attack")
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/roar")
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/launch_land")
            inst.Physics:Stop()
            inst.Physics:SetMotorVelOverride(0,JUMP_SPEED,0)
        end,
...
ground ~= GROUND.WATER_MANGROVE and
...
ground ~= GROUND.OCEAN_HAZARDOUS then
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/breach_attack")
            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/dive_attack")
            inst.sg:SetTimeout(JUMP_SPEED/45 + 0.2)
        end,

        timeline =
        {
            TimeEvent(20*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/roar") end)
        },
...
--            inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/splash_explode")
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(1*FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/hit")
            end),
        },
    ...
    State{
        ...
        timeline =
        {
            ...
            TimeEvent(11*FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/death_sea")
                inst.SoundEmitter:PlaySound("volcano/creatures/seacreature_movement/splash_large")
            end),
        },
    ...
    State{
        ...
        timeline =
        {
            ...
            TimeEvent(0*FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/taunt_sea")
            end),
...
--                end
    ...
    State{
        ...
        onenter = function(inst) 
            inst.components.locomotor:WalkForward()
            inst.AnimState:PlayAnimation("water_run")
            inst.SoundEmitter:PlaySound("volcano/creatures/dogfish/water_swimemerged_med_LP", "walk_loop")
        end,
...
--                end
    ...
    State{
        ...
        timeline=
        {
		TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_emerge_lrg") end),
		TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/sleep") end),
        },
        ...
        timeline=
        {
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_emerge_lrg") end),
        },
...
--{
--    starttimeline = {TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_emerge_lrg") end)},
--    sleeptimeline = {TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/sleep") end)},
--    waketimeline = {TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/tiger_shark/water_submerge_lrg") end)},
