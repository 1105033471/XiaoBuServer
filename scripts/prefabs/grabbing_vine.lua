...
local function fn(Sim)
    ...
    -- inst.entity:AddPhysics()     -- 下面添加的物理属性
    ...
    inst.components.combat.onhitotherfn = function(inst, other, damage) inst.components.thief:StealItem(other) end  -- 由于单联机thief组件不同，这里无法设置偷食物
...
return Prefab( "forest/animals/grabbing_vine", fn, assets, prefabs)