...
local walls_config = {
    ["fence_gate_lock"] = GetLockConfig("door_lock"),
    ["fence_lock"] = GetLockConfig("fence_lock"),
    ["wall_hay_lock"] = GetLockConfig("wall_hay_lock"),
    ["wall_wood_lock"] = GetLockConfig("wall_wood_lock"),
    ["wall_stone_lock"] = GetLockConfig("wall_stone_lock"),
    --["wall_straw_lock"] = GetLockConfig("wall_straw_lock"),
    ["wall_ruins_lock"] = GetLockConfig("wall_ruins_lock"),
    ["wall_moonrock_lock"] = GetLockConfig("wall_moonrock_lock")
}
